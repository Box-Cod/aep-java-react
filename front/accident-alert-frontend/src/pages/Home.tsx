...
// import LoginModal from "../components/LoginModal"; // Importa o modal novo

// export default function Home() {
//   const [openModal, setOpenModal] = useState(false);
//   const [openLoginModal, setOpenLoginModal] = useState(false); // estado para modal login
...
//     // aqui pode colocar ações após login, ex: exibir mensagem, liberar opções, etc
...
//             },
//           }}
//           onClick={() => setOpenLoginModal(true)} // Abre modal login
//         >
//           Login
//         </Button>
//       </Box>
